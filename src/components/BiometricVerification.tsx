    ...
    <Card className="fade-in border-primary/20 shadow-lg">
      <CardHeader className="pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <CardTitle className="text-lg">Stage 2: Biometric Verification</CardTitle>
            <CardDescription>Place finger on scanner or look into iris reader</CardDescription>
          </div>
        </div>
      </CardHeader>
      <CardContent className="space-y-4">
        <div className="flex gap-2">
          <Button
            variant={scanType === 'fingerprint' ? 'default' : 'outline'}
          ...
          <Button
            variant={scanType === 'iris' ? 'default' : 'outline'}
            onClick={() => setScanType('iris')}
            className="flex-1 gap-2"
            disabled={scanning || result === 'success'}
          >
            <ScanEye className="w-4 h-4" /> Iris Scan
          </Button>
        </div>
        ...
        <div className="relative w-32 h-32 mx-auto">
          <div className={cn(
            ...
            result === 'success' && 'border-success bg-success/10',
            result === 'fail' && 'border-destructive bg-destructive/10',
            result === 'idle' && !scanning && 'border-border'
          )}>
          ...
          {scanning && (
            <>
              ...
              <div className="absolute inset-0 overflow-hidden rounded-full">
                <div className="w-full h-1 bg-primary/60 scan-line" />
              </div>
            </>
          )}
        </div>
        ...
        <div className="flex gap-2 pt-2">
          ...
          >
            ...
            ) : result === 'fail' ? 'Retry Scan' : 'Verify Biometric'}
          </Button>
        </div>
        ...
        <div className="pt-2 border-t border-border">
          ...
          >
            👉 Biometric unavailable? Switch to Manual Verification
          </button>
        </div>
      </CardContent>
    </Card>
